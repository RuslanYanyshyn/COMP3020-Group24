...
let restaurant_menus = { 
  ...
  {name: "Breakfast", items: [
    ...
    },
    {
      ...
      img: "./static/menu_pictures/mcdonalds-sausage-n-egg-mcmuffin.jpg?",
      custom: {}
    },
    {
      name: "Hash Brown",
  ...
  {name: "Desserts", items: [
    {
      ...
      price: "2.19",
      calories: 310,
      desc: "Say hello to the HERSHEY'S Sundae Pie. One part crunchy chocolate crust and one part chocolate creme filling garnished with a delicious topping of fudge drizzle and real HERSHEY's chocolate chips.",
      img: "./static/menu_pictures/Hersheys_Sundae_Pie.png?",
      custom: {}
    },
    {
      name: "Apple Turnover",
