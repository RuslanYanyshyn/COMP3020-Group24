let restaurant_menus = { "McDonald's": [
  {name: "Breakfast", items: [
    ...
    },
    {
      ...
      price: "$3.89",
      calories: 430,
      desk: "The savoury taste of sausage, tasty processed cheddar cheese and a freshly-cracked Canada Grade A egg add up to triple deliciousness on a toasty English muffin.",
    ...
    },
    {
      ...
      price: "$1.89",
      calories: 160,
      desk: "That crisp, flaky, fluffy-on-the-inside favourite. A perfect breakfast companion, and irresistible on its own.",
    ...
    },
    {
      ...
      price: "$3.80",
      calories: 550,
      desk: "Three golden-brown, melt-in-your-mouth hotcakes topped with butter and tasty syrup.",
    ...
    },
    {
      ...
      price: "$2.00",
      calories: 280,
      desk: "A savoury mix of fluffy eggs, green peppers, onions, sausage and processed cheddar cheese all wrapped in a warm whole wheat flour tortilla.",
  ...
  {name: "Snacks & Sides", items: [
    ...
    },
    {
      ...
      price: "$0.99",
      calories: 140,
      desk: "Part brownie. Part cookie. All delicious. Enjoy a decadent brownie cookie that’s soft on the inside, crunchy on the outside, and delicious all around.",
    ...
    },
    {
      ...
      price: "$4.89",
      calories: 870,
      desk: "Rich and tasty gravy? Melty, mouth-watering cheese curds? On our World Famous Fries? You better believe it!",
    ...
    },
    {
      ...
      price: "$1.78",
      calories: 380,
      desk: "A perfect companion to coffee; a quick-and-easy mid-morning or afternoon treat. With a choice of five delectable flavours including Banana Chocolate Chunk, Blueberry, Carrot, Fruit ‘n Fibre and Cranberry Orange. Enjoy one today!",
  ...
  {name: "Beverages", items: [
    ...
    },
    {
      ...
      price: "$1.89",
      calories: 4,
      desk: "Brewed from 100% Arabica beans, flame-roasted for a rich, delicious full-bodied flavour &#8208; in your choice of regular or decaf.",
    ...
    },
    {
      ...
      price: "$2.89",
      calories: 170,
      desk: "Treat yourself with the smooth and sophisticated Latte, made with our signature McCaf&egrave; espresso and topped with fresh Canadian milk, steamed and frothed. Visit today!",
    ...
    },
    {
      ...
      price: "$3.69",
      calories: 240,
      desk: "Get a taste of real fruit smoothie blended to perfection with ice. Enjoy it with or without yogurt.",
    ...
    },
    {
      ...
      price: "$2.39",
      calories: 190,
      desk: "The original, refreshing ice-cold cola that goes well with your meal and completes the experience.",
  ...
  {name: "Pizza", items: [
    {
      ...
      price: "$18.25",
      calories: 2100,
      desk: "Fresh Cut Onion, Dry-Cured Pepperoni,Traditional Italian Sausage, Kalamata Sliced Olive, Roasted Red Pepper and Fresh Green Pepper.",
    ...
    },
    {
      ...
      price: "$15.20",
      calories: 2050,
      desk: "Lots of Dry-Cured Pepperoni and Extra Mozzarella Cheese.",
    ...
    },
    {
      ...
      price: "$16.40",
      calories: 1900,
      desk: "Traditional Italian Sausage, Banana, Pepper, Pineapple and Cheddar Cheese.",
    ...
    },
    {
      ...
      price: "$18.90",
      calories: 2350,
      desk: "Genoa Salami, Ham, Dry-Cured Pepperoni, Traditional Italian Sausage, Seasoned Beef and Ground Bacon",
    ...
    },
    {
      ...
      price: "$15.00",
      calories: 1930,
      desk: "Fresh Mushroom, Fresh Cut Onion, Kalamata Sliced Olive, Pineapple, Fresh Green Pepper and Fresh Tomato",
  ...
  {name: "Sides", items: [
    {
      ...
      price: "$6.00",
      calories: 90,
      desk: "Mouth watering cheesesticks with Garlic butter base loaded with 100% Real Cheese and then topped with Dry Cured Pepperoni slices",
    ...
    },
    {
      ...
      price: "$6.00",
      calories: 120,
      desk: "Mouth-watering cheese sticks with Garlic butter base loaded with Mozzarella Cheese and then topped with Sesoned Beef and Spicy Jalapeno slices",
    ...
    },
    {
      ...
      price: "$7.00",
      calories: 700,
      desk: "Grilled chicken strips, side bacon, mozzarella cheese with ranch dressing on soft Ciabatta bread, lightly toasted to perfection.",
  ...
  {name: "Beverages", items: [
    {
      ...
      price: "$2.99",
      calories: 800,
      desk: "Pepsi, Diet Pepsi, 7Up, Dr Pepper, Ginger Ale, Orange Crush, Root Beer, or Iced Tea",
    ...
    },
    {
      ...
      price: "$6.00",
      calories: 150,
      desk: "Any 6: Pepsi, Diet Pepsi, 7Up, Dr Pepper, Ginger Ale, Orange Crush, Root Beer, or Iced Tea.",
    ...
    },
    {
      ...
      price: "$3.00",
      calories: 350,
      desk: "547 ml bottle of refreshing Iced Tea.",
  ...
  {name: "Pizza", items: [
    {
      ...
      price: "$27.99",
      calories: 2100,
      desk: "Signature pizza sauce, chorizo sausage, seasoned ground beef, pizza mozzarella, red onions, jalapeno peppers, and fresh tomatoes.",
    ...
    },
    {
      ...
      price: "$27.99",
      calories: 2340,
      desk: "House-made Bourbon BBQ sauce, bacon, BBQ chicken, balsamic-roasted red onions, pizza mozzarella and cheddar cheese. Finished with a buttermilk ranch drizzle.",
    ...
    },
    {
      ...
      price: "$27.99",
      calories: 2200,
      desk: "Sweet Thai honey garlic, Gouda, provolone, Parmesan, pizza mozzarella, red onions, smoked prosciutto, bacon, pineapple, and toasted sesame seeds.",
    ...
    },
    {
      ...
      price: "$27.99",
      calories: 2200,
      desk: "Marinara sauce, pizza mozzarella, cheddar, spicy chicken breast, roasted garlic, fresh spinach, sun-dried tomatoes and feta.",
    ...
    },
    {
      ...
      price: "$26.99",
      calories: 2500,
      desk: "Beefy Bolognese sauce, pizza mozzarella, smoked ham, pepperoni, seasoned ground beef and spicy Italian sausage.",
  ...
  {name: "Snacks & Sides", items: [
    {
      ...
      price: "$6.99",
      calories: 500,
      desk: "No one's going to be mad at you because you ordered too many fries.",
    ...
    },
    {
      ...
      price: "$4.99",
      calories: 450,
      desk: "A heaping helping of garlicky, fluffy carb-a-licious goodness.",
    ...
    },
    {
      ...
      price: "$3.99",
      calories: 200,
      desk: "So much easier than growing, harvesting, and sauteing your own side order.",
  ...
  {name: "Beverages", items: [
    ...
    },
    {
      ...
      price: "$7.50",
      calories: 400,
      desk: "355 mL Can. Available in Singles, 6-packs and 12-packs.",
    ...
    },
    {
      ...
      price: "$2.50",
      calories: 300,
      desk: "7Up®, Pepsi®, Diet Pepsi®, MUG® Root Beer, Brisk® Iced Tea 591 mL Bottle. Delivery / Pick-Up only.",
    ...
    },
    {
      ...
      price: "$3.49",
      calories: 0,
      desk: "Aquafina® Bottled Water (591ml)",
  ...
  {name: "Salads", items: [
    {
      ...
      price: "$16.49",
      calories: 700,
      desk: "Garden greens, pineapple, beets, red onions, roasted red peppers, goat cheese, slivered almonds, and balsamic dressing.",
    ...
    },
    {
      ...
      price: "$17.99",
      calories: 1200,
      desk: "Garden greens, candied pecans, pizza mozzarella, cheddar, bacon, cucumbers, carrots, tomatoes, and ranch dressing.",
    ...
    },
    {
      ...
      price: "$16.49",
      calories: 700,
      desk: "Grilled chicken breast, carrots, beets, crunchy Asian noodles, pineapple and green onions, on a bed of romaine lettuce and quinoa and rice blend with Thai chili citrus dressing and sesame seeds.",
  ...
  {name: "Desserts", items: [
    {
      ...
      price: "$6.99",
      calories: 300,
      desk: "Freshly baked Canadian Northern Spy apples in a flaky pastry shell. Served with vanilla ice cream and drizzled with caramel sauce",
    ...
    },
    {
      ...
      price: "$7.99",
      calories: 400,
      desk: "Traditional New York–style cheesecake with a graham cracker crust",
    ...
    },
    {
      ...
      price: "$8.99",
      calories: 600,
      desk: "Creamy chocolate mousse with chunks of cheesecake, caramel, toffee, pecans and almonds on a chocolate crust.",
  ...
  {name: "Burgers", items: [
    {
      ...
      price: "$9.89",
      calories: 1280,
      desk: "The Roadhouse KING™ Sandwich features two quarter-pound savoury flame-grilled beef patties, topped with four half-strips of thick-cut smoked bacon, crispy onion rings, tangy barbeque sauce, American cheese, and creamy mayonnaise all on a sesame seed bun.",
    ...
    },
    {
      ...
      price: "$8.79",
      calories: 990,
      desk: "Now made with 2X more of Burger King's famous Stacker Sauce, the Big King XL is back and bigger than ever. With over half a pound of flame-grilled beef, all the fixings, and now double the stacker sauce, the Big King XL will satisfy any hunger.",
    ...
    },
    {
      ...
      price: "$7.69",
      calories: 580,
      desk: "The Quarter Pound King™ features a quarter-pound savoury flame-grilled beef patty, topped with all of the classic favourites: melted cheese, freshly sliced onions, zesty pickles, ketchup, and mustard all on a toasted sesame seed bun.",
    ...
    },
    {
      ...
      price: "$6.99",
      calories: 660,
      desk: "The WHOPPER® Sandwich is a quarter pound (based on pre-cooked patty weight) of savoury flame-grilled beef topped with juicy tomatoes, fresh-cut lettuce, creamy mayonnaise, crunchy pickles, and sliced white onions on a toasted sesame seed bun. WHOPPER® is a registered mark of Burger King Corporation.",
    ...
    },
    {
      ...
      price: "$2.49",
      calories: 280,
      desk: "You can’t go wrong with Cheeseburger. A signature flame-grilled beef patty topped with a simple layer of melted cheese, crunchy pickles, yellow mustard, and ketchup on a toasted sesame seed bun.",
  ...
  {name: "Breakfast", items: [
    {
      ...
      price: "$1.89",
      calories: 250,
      desk: "Make your morning sizzle with a side of crunchy and golden hash browns.",
    ...
    },
    {
      ...
      price: "$3.59",
      calories: 310,
      desk: "Sweet, golden brown, and piping hot, French Toast Sticks are perfect for dipping in a side of sweet syrup.",
    ...
    },
    {
      ...
      price: "$5.49",
      calories: 480,
      desk: "The grab-and-go Sausage, Egg, & Cheese CROISSAN’WICH® is piled high with savoury sizzling sausage, eggs, and melted cheese on a toasted, flaky croissant.",
    ...
    },
    {
      ...
      price: "$5.49",
      calories: 360,
      desk: "The Sausage, Egg, & Cheese English Muffin Sandwich is a combination of savoury sizzling sausage, tender eggs, and melted cheese nestled inside a toasted English muffin.",
    ...
    },
    {
      ...
      price: "$4.79",
      calories: 450,
      desk: "Three warm, fluffy pancakes flavoured with a hint of vanilla and served with syrup.",
  ...
  {name: "Beverages", items: [
    {
      ...
      price: "$1.79",
      calories: 130,
      desk: "Delicious and creamy, hot chocolate is simply a classic treat.",
    ...
    },
    {
      ...
      price: "$1.79",
      calories: 5,
      desk: "Smooth Roast Coffee is made from 100% Arabica beans that delivers a balanced mild flavour and pairs perfectly with breakfast, lunch or dinner.",
    ...
    },
    {
      ...
      price: "$1.79",
      calories: 0,
      desk: "Delicious hot tea made just your way.",
      img: "https://cdn.sanity.io/images/czqk28jt/prod_bk_us/23089bc5d8c85058f0bb653c2c000a9c41b82baa-870x570.png?w=320&fm=webp&q=40&fit=max"
    },
    {
      name: "Soft Drink",
      price: "$2.70",
      calories: 250,
      desk: "7Up®, Pepsi®, Diet Pepsi®, MUG® Root Beer.",
  ...
  {name: "Desserts", items: [
    {
      ...
      price: "$2.19",
      calories: 310,
      desk: "Say hello to the HERSHEY'S® Sundae Pie. One part crunchy chocolate crust and one part chocolate creme filling garnished with a delicious topping of fudge drizzle and real HERSHEY's® chocolate chips. The HERSHEY’S® trademark and trade dress are used under license by Burger King Corporation.",
    ...
    },
    {
      ...
      price: "$1.69",
      calories: 260,
      desk: "The Apple Turnover has a flaky, golden crust with a delicious, warm apple filling. It's the perfect way to finish any meal.",
    ...
    },
    {
      ...
      price: "$2.19",
      calories: 260,
      desk: "Cool and creamy, the made-to-order Chocolate Fudge Sundae is prepared with a velvety vanilla soft serve and finished with a delicious fudge swirl.",
  ...
  {name: "Sushi", items: [
    {
      ...
      price: "$8.99",
      calories: 470,
      desk: "ALLERGEN ALERT: CRUSTACEAN, WHEAT, SOY, FISH, EGG, MUSTARD, SESAME. MAY CONTAIN MILK, SULPHITES.",
    ...
    },
    {
      ...
      price: "$12.89",
      calories: 480,
      desk: "ALLERGEN ALERT:FISH, CRUSTACEAN, WHEAT, SOY, EGG, MUSTARD, SESAME. MAY CONTAIN MILK, SULPHITES.",
    ...
    },
    {
      ...
      price: "$4.99",
      calories: 400,
      desk: "ALLERGEN ALERT:CONTAINS: WHEAT, SOY, EGG, MUSTARD, SESAME, SULPHITES. MAY CONTAIN FISH, CRUSTACEAN, MILK.",
    ...
    },
    {
      ...
      price: "$6.99",
      calories: 360,
      desk: "ALLERGEN ALERT:FISH, MILK, WHEAT, SOY, MUSTARD, SESAME. MAY CONTAIN EGG, CRUSTACEAN, SULPHITES.",
  ...
  {name: "Bowls", items: [
    {
      ...
      price: "$6.99",
      calories: 710,
      desk: "ALLERGEN ALERT:WHEAT, SOY, EGG, MILK. MAY CONTAIN FISH, CRUSTACEAN, MUSTARD, SESAME, SULPHITES.",
    ...
    },
    {
      ...
      price: "$5.99",
      calories: 470,
      desk: "ALLERGEN ALERT:CONTAINS: SOY, WHEAT, FISH, CRUSTACEAN, EGG. MAY CONTAIN MILK, MUSTARD, SESAME, SULPHITES.",
    ...
    },
    {
      ...
      price: "$4.99",
      calories: 460,
      desk: "ALLERGEN ALERT: CONTAINS: WHEAT, SOY, SESAME. MAY CONTAIN FISH, CRUSTACEAN, EGG, MILK, MUSTARD, SULPHITES.",
    ...
    },
    {
      ...
      price: "$9.99",
      calories: 1060,
      desk: "ALLERGEN ALERT:SOY, WHEAT, FISH, SESAME, SULPHITES, EGG. MAY CONTAIN CRUSTACEAN, MUSTARD, MILK.",
    ...
    },
    {
      ...
      price: "$7.99",
      calories: 450,
      desk: "ALLERGEN ALERT: CONTAINS: SOY, WHEAT, SESAME. MAY CONTAIN FISH, CRUSTACEAN, EGG, MILK, MUSTARD, SULPHITES.",
