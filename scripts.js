...
var radiusBefore;
var circleToContract;
var infoToContract;
function expand(circleID, contentID){
  let circle=document.getElementById(circleID);
  let circleInfo=document.getElementById(contentID);
  circleToContract=document.getElementById(circleID);
  infoToContract=document.getElementById(contentID);
  if(circle.getAttribute('r')<80){
    radiusBefore=circle.getAttribute('r');
  }
...
function contract(bubble, info){
  let circle=document.getElementById(bubble);
  //let circleInfo=document.getElementById(contentID);
  bubble.setAttribute('r',radiusBefore);
...
function off() {
  ...
  contract(circleToContract, infoToContract);
}
